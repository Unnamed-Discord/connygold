...
PryceText_Intro:
	...
	para "There have been so"
	line "many attemps to"
	cont "ruin my hard work."
	
	para "Yet, experience"
	line "has taught me that"
	cont "dedication wins."
	...
	line "born. A true"
	cont "boomer connection."

	para "I do not lose"
	line "easily to zoomers"
	cont "like you."
