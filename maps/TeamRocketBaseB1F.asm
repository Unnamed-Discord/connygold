...
CameraGrunt2BeatenText:
	...
	para "Unless… you would"
	line "be inclined to"
	cont "join TEAM JUMBO?"
...
ScientistJedSeenText:
	...
	para "Now it's a meme"
	line "hideout for our"
	cont "bird-person cult."
...
GruntM16SeenText:
	...
	para "Everything will"
	line "soon be bathed in"
	cont "JUMBO's light."
	done
