...
CinnabarIslandBlueText:
	...
	para "Well, I come from"
	cont "PALLET TOWN."
	
	para "You may have heard"
	line "two trainers there"
	cont "were CHAMPION."
	
	para "Well, I want to be"
	line "great just like"
	cont "them!"
	
	para "Did you want to"
	line "challenge me or"
	cont "something?"
	...
	line "we will get the"
	cont "chance very soon."
