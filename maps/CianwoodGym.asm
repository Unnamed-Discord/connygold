...
ChuckIntroText1:
	...
	line "are people who try"
	cont "to ruin things?"
	
	para "They think they"
	line "are being funny,"
	cont "yet no one laughs."
	
	para "Try as they might,"
	line "their efforts are"
	cont "always fruitless!"
	
	para "Something tells me"
	line "if they continue…"
	
	para "Well, I'll just"
	line "have to give them"
	cont "a swift kick!"
