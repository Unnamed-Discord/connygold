...
INCLUDE "engine/gfx/player_gfx.asm" ; ported from crystal
INCLUDE "engine/menus/init_gender.asm" ; ported from crystal
INCLUDE "data/battle/ability_names.asm"

; credit to pokecrystal wiki
