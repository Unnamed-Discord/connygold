...
BillsPCDepositJumptable:
	...
	;dw BillsPCDepositFuncOffer ; Offer to Jumbo, was present in the live play through to prevent releasing
...
BillsPCDepositFuncOffer:
	ld de, .PCString_Offer
	call BillsPC_PlaceString
	ret    
.PCString_Offer:
    db "JUMBO: Not today.@"
...
.dw ; Withdraw Jumptable
	dw .withdraw ; Withdraw
	dw .stats ; Stats
	dw .release ; Release
	;dw .offer ; Offer to Jubmo (present in live play through)
	dw .cancel ; Cancel
