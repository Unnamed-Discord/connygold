...
; Moon Stone's constant from Pokémon Red wass used in base game.
; No Pokémon evolve with Burn Heal,
; so Moon Balls always had a catch rate of 1×. Fixed!
	push bc
	ld a, BANK("Evolutions and Attacks")
	call GetFarByte
	cp MOON_STONE ; This was originally BURN_HEAL...
	pop bc
	ret nz
