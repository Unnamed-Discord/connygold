...
FalknerGroup:
	...
	db  12, PIDGEY,     SAND_ATTACK, GUST, QUICK_ATTACK, NO_MOVE
	db -1 ; end
...
MortyGroup:
	...
	db 24, PIDGEY,     SAND_ATTACK, GUST, QUICK_ATTACK, NO_MOVE
	db -1 ; end
...
ClairGroup:
	...
	db 36, PIDGEY,     SAND_ATTACK, GUST, QUICK_ATTACK, NO_MOVE
	db -1 ; end
...
BrockGroup:
	...
	db 48, PIDGEY,     SAND_ATTACK, GUST, QUICK_ATTACK, NO_MOVE
	db -1 ; end
...
YoungsterGroup:
	; YOUNGSTER (1)
	db "CONNY JR@", TRAINERTYPE_NORMAL
	db  4, RATTATA
	db -1 ; end
...
LassGroup:
	...
	; LASS (5)
	db "PERSISTA@", TRAINERTYPE_NORMAL
	db 21, MARILL
	db -1 ; end
...
BeautyGroup:
	; BEAUTY (1)
	db "HEEDRIANNE@", TRAINERTYPE_NORMAL
	db  9, SENTRET
	db 13, SENTRET
	db 17, SENTRET
	db -1 ; end
...
RedGroup:
	; RED (1)
	db "CNSTNTN@", TRAINERTYPE_MOVES
	db 81, ARCANINE,   HORN_ATTACK, FLAMETHROWER, FIRE_BLAST, NO_MOVE ; male
	db 74, DRAGONITE,  WRAP, THUNDER_WAVE, WING_ATTACK, HYPER_BEAM ; male
	db 76, ZAPDOS,     THUNDERSHOCK, DRILL_PECK, THUNDER, LIGHT_SCREEN
	db 79, LAPRAS,     SURF, HYDRO_PUMP, GROWL, ICE_BEAM
	db 78, ALAKAZAM,   TELEPORT, PSYCHIC_M, RECOVER, PSYBEAM ; male
	db 82, MEWTWO,     PSYCHIC_M, AMNESIA, RECOVER, DISABLE
	db -1 ; end
...
BlueGroup:
	...
	db 60, PIDGEY,     QUICK_ATTACK, WHIRLWIND, WING_ATTACK, MIRROR_MOVE
	db -1 ; end
...
AgathaGroup:
	...
	db 69, GENGAR,     SHADOW_BALL, HYPNOSIS,    DREAM_EATER, PSYCHIC_M
	db 68, CROBAT,     CONFUSE_RAY, WING_ATTACK, SLUDGE_BOMB, NO_MOVE
	db 70, MISDREAVUS, SHADOW_BALL, THUNDERBOLT, PSYCHIC_M,   ATTRACT
	db 69, ARBOK,      DOUBLE_TEAM, SLUDGE_BOMB, EARTHQUAKE,  GIGA_DRAIN
	db 70, MURKROW,    NIGHT_SHADE, FAINT_ATTACK,PURSUIT,     HAZE 
	db 72, PIDGEOT,    WING_ATTACK, WHIRLWIND,   AGILITY,     QUICK_ATTACK
	db -1 ; end
