...
; entries correspond to SPRITE_* constants
	...
	overworld_sprite KrisSpriteGFX, 12, WALKING_SPRITE, PAL_OW_BLUE ; ported from Crystal
	overworld_sprite KrisBikeSpriteGFX, 12, WALKING_SPRITE, PAL_OW_BLUE ; ported from Crystal
